  ...
  return (
    <>
      ...
      <div className="justify-center min-h-screen overflow-hidden  ">
        ...
        <div className='grid  grid-cols-2 gap-4 lg:grid-cols-4 mt-8 justify-center mx-12 md:mx-0    '>
          <motion.div
        ...
        <div className='lg:flex mt-8  lg:mx-0 justify-evenly'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-3 mx-12  lg:ml-0     lg:gap-10 gap-6 lg:mt-4 mt-10  '>
          ...
          <div className='grid grid-cols-3 lg:grid-cols-1 mx-12 md:mx-0 lg:mx-0 mt-10 lg:mt-4  md:pl-12  gap-4    '>
            <motion.div
              initial={{ opacity: 0, scale: 0.8, y: 20 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 3.2, ease: 'easeInOut' }}>
