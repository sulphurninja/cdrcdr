...
export default function IMEIInfo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(`/api/imei?imei=${imei}`);
      ...
      <div className="md:flex justify-evenly">
        ...
        >
          <form
            ...
            className="justify-evenly space-x-4 flex md:ml-18 mx-16 mt-20"
          >
            <input
              type="text"
              value={imei}
            ...
            />
            <button
              className="bg-white -400 font-bold font-mono hover:bg-green-200 -700 text-black px-4 rounded-xl"
              type="submit"
            >
              Submit
            </button>
